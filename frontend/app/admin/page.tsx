            ...
            <div style={{ ...card, padding: 20 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {[
                  ...
                  { label: "Средства пула", value: `${(data.admin_own_capital + data.admin_own_pnl + (data.admin_income || 0)).toFixed(2)} $`, color: (data.admin_own_capital + data.admin_own_pnl + (data.admin_income || 0)) >= 0 ? "#22c97a" : "#ff4d4d" },
          ...
          <div style={{ ...card, padding: 0, border: "1px solid rgba(255,255,255,0.08)", overflow: "hidden" }}>
            ...
            {dangerZoneOpen && (
              <div style={{ padding: "0 16px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                {/* Сброс глюка пула */}
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                  padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,153,68,0.3)", marginTop: 12 }}>
                  <div>
                    <p style={{ color: "#ff9944", fontSize: 13, fontWeight: 600 }}>🐛 Отмена пополнения из пула</p>
                    <p style={{ color: muted, fontSize: 12, marginTop: 4 }}>Отменяет влияние последней кнопки "Пополнить из пула" на баланс пула.</p>
                  </div>
                  <button onClick={async () => {
                    ...
                    try {
                      ...
                      background: "rgba(68,34,13,0.8)", color: "#ff9944", cursor: "pointer", border: "1px solid rgba(255,153,68,0.3)", whiteSpace: "nowrap" }}>
                    Сбросить глюк
                  </button>
                </div>
                ...
                {/* Очистка демо */}
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                  padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,77,77,0.15)", marginTop: 12 }}>
                  <div>
                  ...
                  <button
                    ...
                    style={{ marginLeft: 16, padding: "8px 16px", borderRadius: 8, fontSize: 12, fontWeight: 600,
                      background: "rgba(127,29,29,0.7)", color: "#fca5a5", cursor: "pointer", border: "1px solid rgba(255,77,77,0.2)",
                ...
                {!isForex && (
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                    padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,77,77,0.3)", marginTop: 12 }}>
                    <div>
                ...
                {isForex && (
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                    padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(252,211,77,0.3)", marginTop: 12 }}>
                    <div>
        ...
        {activeTab === "deposits" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            {poolProfitMatches && poolProfitMatches.profit > 0 && activePool === "crypto" && (() => {
              ...
              return (
                <div style={{
                  background: "linear-gradient(135deg, rgba(34,201,122,0.12) 0%, rgba(68,136,221,0.10) 100%)",
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div>
                      <p style={{ color: "#22c97a", fontWeight: 700, fontSize: 14, margin: 0 }}>
                        Прибыль пула: +{poolProfitMatches.profit.toFixed(2)} USDT
                      </p>
                    ...
                    {visibleMatches.map(m => (
                      <div key={m.id} style={{
                        ...
                        <div>
                          ...
                          <span style={{ color: "#22c97a", fontWeight: 700, fontSize: 14, marginLeft: 12 }}>
                        ...
                        <div style={{ display: "flex", gap: 8 }}>
                          <button
                            onClick={async () => {
                              if (!confirm(`Покрыть заявку ${m.email} на ${m.amount} USDT из прибыли пула?`)) return;
                              try {
                                await approveDepositFromPool(m.id, m.amount);
                                setDismissedMatchIds(prev => new Set([...prev, m.id]));
                                fetchData();
                              } catch (e: any) {
                                alert("Ошибка: " + (e?.response?.data?.detail || e?.message));
                              }
                            ...
                            style={{
                              ...
                              background: "rgba(34,201,122,0.7)", color: "#fff",
